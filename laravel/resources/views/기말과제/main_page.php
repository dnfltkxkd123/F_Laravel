  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active" >
        <img class='p' src="images/main1.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item" >
        <img class='p' src="images/main2.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item" >
        <img class='p' src="images/main3.jpg" alt="New york" style="width:100%;">
      </div>
    </div>

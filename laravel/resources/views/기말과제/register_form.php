...
?>
  ...
  <div class="row">
      <!-- left column -->
      <form  role="form"  action='register' method='post' enctype='multipart/form-data' id='form'>
      ...
      <div class="col-md-9 personal-info" role="form">
        ...
        <div class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-3">
              <input type="button" id='submit' class="btn btn-primary" value="저장"  onclick="fileCheck('#test','register')">
              <span></span>

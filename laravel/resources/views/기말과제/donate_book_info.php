...
<script>
	<?php if($data['sale_status']=='sale'):?>
		var r = $("<button type='button' class='btn btn-success btn-product' id='button' title='Edit' onclick='check(<?=$loginOk?>)'><span class='glyphicon glyphicon-shopping-cart'>책받기</span></button>")
	<?php endif ?>

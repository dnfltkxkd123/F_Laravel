...
$(document).ready(function(){
  var myKey = "sX0sMAuo3SEqKBxSnhXA9g"; // sweet tracker에서 발급받은 자신의 키 넣는다./
    ...
    function insertInvoiceNumber(url){
      var formData = new FormData($('#form')[0]);
      //alert(formData.get('code'));
      $.ajax({
        type:'post',
        url:url,
        data:formData,
                ...
                <table class="table table-striped table-bordered" >
                  ...
                  <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="#" class="btn btn-info" onclick="insertInvoiceNumber('insert_invoice_num')"><span class=""></span>배송정보등록</a>
                            </td>
                          </tr>
                    <?php endforeach?>
                        </tbody>

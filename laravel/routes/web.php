...
Route::get('login','MemberController@insert');
...
Route::get('buyedBook','DonateController@buyedPagenation');
Route::get('soldBook','DonateController@soldOutPagenation');


Route::get('api',function(){
	return view('기말과제.TestApi');
});

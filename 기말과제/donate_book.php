...
<head>
  ...
  <script>
      function loginCheck(check){
        if(check){
            location.href='recommend_form.php';
        }else{
            alert('로그인 해주세요!!');
        }
      }
        ...
        <ul class="l-row">
            <li class="l-col" style='cursor:pointer;'>
                <div class="editor brackets">
                    <img class="editor-icon" src="test.png" width='100%' onclick="location.href='donate_book_info.php'">
                    <p>돌이킬 수 없는 약속</p>
                    <button type="button" class="btn btn-success btn-product" title="Edit" onclick="location.href='orderSample.php'"><span class='glyphicon glyphicon-shopping-cart'>책받기</span></button>
                    <br>
                    <br>
                </div> 
            </li>
